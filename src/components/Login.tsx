          ...
          <form onSubmit={handleSubmit} className="space-y-7">
            <div className="space-y-1.5">
              ...
              <input
                ...
                className="w-full bg-transparent border-b border-premium-muted/40 dark:border-premium-border py-3 text-premium-text focus:border-premium-gold outline-none transition-all duration-300 font-light"
                required
                autoComplete="email"
              />
            </div>
